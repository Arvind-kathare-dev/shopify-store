...
import { Lock, Phone, ShieldCheck, Check, CheckCircle } from "lucide-react";
...
export default function CTAFormAdvanced() {
  ...
  return (
    <div className="w-full p-4 bg-primary rounded-2xl flex justify-center items-center">
     {/* Modal shell */}
      <motion.div
        ...
        className="relative z-10 w-full justify-between p-8 max-w-[1240px] bg-primary  overflow-hidden  flex"
        style={{ minHeight: 420 }}
      >
        {/* ── Left panel ── */}
        ...
        <div className="flex-1 max-w-[715px] bg-white rounded-2xl  p-6 flex flex-col overflow-hidden relative">
          {/* Close button */}
          ...
          <AnimatePresence mode="wait">
            {done ? (
              ...
              <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col flex-1">
                ...
                <div className="flex-1 overflow-y-auto p-1" style={{ maxHeight: 325 }}>
